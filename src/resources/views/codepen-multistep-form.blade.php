...
<html lang="en">
    ...
    <body  class="duration-300 relative transform transition-all hidden ease-out"
          data-replace='{ "hidden": "" }'
    >

        <div id="cover" x-data="app()" x-cloak >
                    ...
                    <div class="py-10">
                        <div x-show.transition.in="step === 1">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="email" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your email address...">
                            </div>
                        </div>
                        ...
                        <div x-show.transition.in="step === 3">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="profession" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="eg. Web Developer">
                            </div>
                        </div>
                    </div>
                    <!-- / Step Content -->

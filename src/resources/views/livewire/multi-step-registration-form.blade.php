<x-papiforms::layouts.app>
    <div x-cloak x-data="app()" class="duration-300 relative transform transition-all hidden ease-out"
    data-replace='{ "hidden": "" }'
    >
        <div class="max-w-3xl mx-auto px-4 py-10">
            ...
            <div x-show.transition="step != 'complete'">
                ...
                <!-- /Top Navigation -->
                <!-- Step Content -->
                <div class="py-10" wire:loading.delay-500>
                    ...
                    <div x-show.transition.in="step === 3">
                        <x-papiforms::forms.registration.steps.address />
                    </div>
                    <div x-show.transition.in="step === 4">
                        <x-papiforms::forms.registration.steps.step3 />
                    </div>
